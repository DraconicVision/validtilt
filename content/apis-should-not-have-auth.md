...
description: Authentication is an accusation, in JSON, from a stranger who knows me less well than I do.
tags:
  - apis
  - auth
  - rant
...
I can only assume the support teams are lonely. There is no other explanation for an onboarding process whose final stage is a week of email correspondence with Ben from support, whose job (as far as I can tell) is to establish that I am me. I could tell him that. I have been telling everyone that, for free, since birth.

Some APIs have dashboards where you can manage your own tokens, permissions and IP whitelists. An achievement, kind of: they have removed the human being from the process of not trusting you.

These admin dashboards with an API on the side are not necessarily the problem, they're just rare. There will be more on this in a future post, *'Don't ask for an OTP, I might end up on Instagram'*.
...
I won't even get started on authenticating external webhooks. You sent me the message. I do not need to prove who I am to a message I am receiving.

Until then, every 401 I receive will be read as intended: an accusation, in JSON, from a stranger who knows me less well than I do.
